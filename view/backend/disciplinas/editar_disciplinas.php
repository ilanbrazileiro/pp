          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar Disciplina <small>Atenção ao dados requeridos</small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" id="quickForm" action="" method="post" enctype="multipart">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="titulo" class="form-control" placeholder="Digite umm titulo para o Curso" value="<?= $disciplina['titulo'] ?>">
                  </div>

                  <div class="form-group">
                    <label for="slug">Slug da Disciplina</label>
                    <input type="text" name="slug" class="form-control" placeholder="Digite o titulo sem espaços" value="<?= $disciplina['slug'] ?>">
                  </div>

                  <div class="form-group">
                    <label for="descricao">Descrição do Curso</label>
                    <textarea class="textarea" name="descricao"><?= $disciplina['descricao'] ?></textarea>
                  </div>
                      ...
                      <div class='checkbox-inline'>
                          <label>
                            <?php foreach ($cursos as $value) {
                              ...
                              if ($disciplinas->checkCurso($value['id_curso'], $disciplina['id_disciplina']) === true){
                                $checked = 'checked';
                              } else {
                                $checked = '';
                              }
